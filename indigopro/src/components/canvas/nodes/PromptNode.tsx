  ...
  return (
    <div
      className={clsx(
        ...
        selected ? 'border-indigo-400 shadow-indigo-100 shadow-md' : 'border-slate-200'
      )}
    >
      ...
      <div className="p-3 space-y-2">
        <select
          ...
          className="w-full text-xs border border-slate-200 rounded-lg px-2 py-1.5 text-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-400"
        >
        ...
        <textarea
          className="w-full text-sm text-slate-700 border border-slate-200 rounded-lg px-2 py-1.5 resize-none focus:outline-none focus:ring-1 focus:ring-indigo-400 placeholder:text-slate-400"
          value={promptText}
        ...
        <button
          ...
          className="w-full bg-indigo-500 text-white text-xs font-semibold py-2 rounded-lg hover:bg-indigo-600 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Generate →
        </button>
      </div>
